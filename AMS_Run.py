...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="pink", width=9, height=1, activebackground="Red",
        ...
        if subb == '':
            ...
            def enter_data_DB():
                ...
                if ENROLLMENT == '':
                    ...
                    Insert_data = "INSERT INTO " + attendances + \
            ...
            def create_csv():
                ...
                csv_name = 'D:/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance'+attendances+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/-------Check atttendance-------"')
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password=''your_password', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
